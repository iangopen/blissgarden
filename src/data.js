...
export const BASIC_SEEDS = ['potato','carrot','wheat','sunflower'];

export const SEED_SELL_PRICES = {
...
export const COL_MAP = { seed:0, sprout:1, grown:2 };

export const ITEM_ICONS = { water:'💧', cage:'🔒', fertilizer:'🌿', uncommonFert:'⚗️', hiredHand:'👨‍🌾' };

export const MILESTONE_VALS = [100, 1000, 10000, 100000, 1000000];
export const STAGES = [
...
export const WEED_CLICKS = 20;
export const THORNED_WEED_CLICKS = 50;
export const VOID_RIFT_CLICKS = 15;
