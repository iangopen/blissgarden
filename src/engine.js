...
import { eventInterval, getEffectiveSpeedMult, isReady, stageValue } from './upgrades.js';
import { craftTick } from './crafting.js';
import { log } from './render/log.js';
import { canTick, tickSellBox } from './events/sellTick.js';
import { Events, dropLoose, getCurrentStage } from './events/index.js';
import { RenderFarm, renderLoose, updateTimers } from './render/farm.js';
...
// Registers the game timers and starts the one 50 ms tick. Called first from main.js start().
...
export function setupTimers() {
  ...
  TimerManager.timers['craftTick'].fn        = craftTick;
